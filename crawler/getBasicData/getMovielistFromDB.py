...
# 		movie_tag_lists = ['经典']
# 		movie_lists = self.do_spider(self,movie_tag_lists)
# 		self.print_movie_lists_excel(self,movie_lists,movie_tag_lists)
#
# 	def do_spider(self, movie_tag_lists):
# 		movie_lists=[]
# 		for movie_tag in movie_tag_lists:
# 			movie_list=self.movie_spider(self,movie_tag)
...
# 					url_list=titleFull.get('href')
# 					# movieModel = getDetailInfoOfMovie(self,title,url_list) 
# 					# movie_list.append(movieModel)
#
...
# 		wb.save(save_path)
#
# 	def getDetailInfoOfMovie(self,title,url_list):
# 			movie_model = []
#
# 			time.sleep(np.random.rand()*2)
#
# 			try:
# 				req_detail = urllib2.Request(url_list)
